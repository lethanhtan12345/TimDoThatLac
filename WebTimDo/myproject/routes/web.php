...
//Route cho nười dùng
Route::get('/admin/tai-khoan',[AdminController::class,'TaiKhoan']);
Route::get('/admin/tin-tuc-nguoi-dung',[AdminController::class,'TinTucNguoiDung']);
Route::get('/admin/cap-nhat-nguoi-dung/{id}',[AdminController::class,'CapNhatNguoiDung']);
Route::post('/admin/cap-nhat-nguoi-dung/{id}',[AdminController::class,'post_CapNhatNguoiDung'])->name('xu-li-cap-nhat-nguoi-dung');

Route::get('/admin/cap-nhat-tin-tuc/{id}',[AdminController::class,'CapNhatTinTuc']);
Route::post('/admin/cap-nhat-tin-tuc/{id}',[AdminController::class,'post_CapNhatTinTuc'])->name('xu-li-cap-nhat-tin-tuc');
Route::get('/admin/xoa-tin-tuc/{id}',[AdminController::class,'XoaTinTuc'])->name('xoa-tin-tuc');
...
Route::get('/admin/them-tin',[AdminController::class,'ThemTin'])->name('them-tin');
Route::post('/admin/them-tin',[AdminController::class,'post_ThemTin'])->name('xu-li-them-tin');


Route::get('/admin/trang-chu',[AdminController::class,'index'])->name('trang-chu')->middleware('auth');
Route::get('/admin/nhat-do',[AdminController::class,'NhatDo']);
Route::get('/admin/tim-do',[AdminController::class,'TimDo']);
Route::get('/admin/bo-loc',[AdminController::class,'Boloc']);
//Route cho nười dùng
